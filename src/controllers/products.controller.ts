...
import {
  getProductsService,
  getSpecificProductsService,
} from "../services/Products/get.service";
...
export const getProductsController = async (req: Request, res: Response) => {
  ...
  const products: IGetProducts = await getProductsService(
    orderBy,
    page,
    limit,
    name
...
export const getSpecificProductController = async (
  req: Request,
  res: Response
) => {
